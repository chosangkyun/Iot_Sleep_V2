#ifndef __CColorPOPUP_H__
#define __CColorPOPUP_H__
...
#define	CBO_MODECHANGE		 WM_USER + 1006        // Change track mode
#define WM_CHECKFILL		 WM_USER + 1007
...
#endif // !defined(__CColorPOPUP_H__)
